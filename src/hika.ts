...
export class Game {
	...
	private setPiecePoi(pos: Vec, piece: Space = null): Space {
		let target: Space = null;
	...
	private removePoi(pos: Vec): Space {
		let target: Space = null;
		for (let i of this.pois) {
			if (i.pos.equals(pos)) {
				target = i.piece;
	...
	public forPiece(fn: (loc: Vec, piece: Space) => void): void {
